  ...
  */
  ...
  JqTreeWidget = (function(_super) {
    ...
    JqTreeWidget.prototype._createDomElements = function(tree, $element) {
      ...
      createNodeLi = function(node) {
        return $("<li data-id=\""+node.id+"\"><div><span class=\"title\">" + node.name + "</span></div></li>");
      };
      createFolderLi = function(node) {
        ...
        return $("<li data-id=\""+node.id+"\" class=\"" + folder_class + "\"><div><a class=\"" + button_class + "\">&raquo;</a><span class=\"title\">" + node.name + "</span></div></li>");
      };
  ...
  GhostDropHint = (function() {
    ...
    function GhostDropHint(node, $element, position) {
      ...
      this.node = node;
      this.$ghost = $('<li data-id=\""+node.id+"\" class="ghost"><span class="circle"></span><span class="line"></span></li>');
      if (position === Position.AFTER) {
        this.moveAfter();
      } else if (position === Position.BEFORE) {
        this.moveBefore();
